mkdir -p out
m68k-linux-gnu-as -m68000 --register-prefix-optional -o out/Routines.o Routines.s
...
m68k-linux-gnu-gcc -Llib -m68000 -Wall -nostartfiles -nodefaultlibs -fno-builtin -fomit-frame-pointer -ffast-math -Wl,-Map,game.map -Wl,--build-id=none -T CPS1.x -o out/game.obj out/StartUp.o out/Routines.o out/main.o
